...
env: 
  ...
  TZ: Asia/Shanghai
  GITHUB_RELEASE: https://github.com/gogogojason/RM2100/releases
...
jobs: 
  build:
    ...
    strategy:
      fail-fast: false
      matrix:
        target: [Sim_K2P]  #[Lean_x86_64,All_RM2100,Sim_RM2100,Ap_RM2100,Lienol_x86_64,]
