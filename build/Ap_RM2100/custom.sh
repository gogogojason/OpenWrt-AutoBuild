...
echo -e "sed -i \t\'$a src/gz jason_packages http://openwrt.ink:8666/RedMi2100/Packages/\' /etc/opkg/distfeeds.conf" >>package/lean/default-settings/files/zzz-default-settings
